...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 6 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\sessions](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\sessions) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package sessions -Apply
