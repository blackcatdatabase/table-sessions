...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 6 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\sessions](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\sessions)
...
graph LR
  ...
  sessions["sessions"]:::center
  sessions -->|FK| users["users"]:::link
...
- token_issued_at (token)

## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package sessions -Apply
