...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'token_hash', 'token_hash_key_version', 'token_fingerprint', 'token_issued_at', 'user_id', 'created_at', 'version', 'last_seen_at', 'expires_at', 'failed_decrypt_count', 'last_failed_decrypt_at', 'revoked', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'session_blob' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'token_hash' ], [ 'constraint' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'user_id', 'version', 'failed_decrypt_count' ]; }
