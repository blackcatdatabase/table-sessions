...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'token_hash', 'token_hash_key_version', 'token_fingerprint', 'token_issued_at', 'user_id', 'created_at', 'version', 'last_seen_at', 'expires_at', 'failed_decrypt_count', 'last_failed_decrypt_at', 'revoked', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'session_blob' ];
    }
    ...
    {
        $x = [ 'id', 'token_hash_key_version', 'token_issued_at', 'user_id', 'created_at', 'version', 'last_seen_at', 'expires_at', 'failed_decrypt_count', 'last_failed_decrypt_at', 'revoked', 'ip_hash_key_version', 'user_agent' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Sessions\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Sessions\Definitions::softDeleteColumn();
