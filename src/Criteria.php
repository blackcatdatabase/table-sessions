 ...
 * - whitelist filtrů: [ 'id', 'token_hash', 'token_hash_key_version', 'token_fingerprint', 'token_issued_at', 'user_id', 'created_at', 'version', 'last_seen_at', 'expires_at', 'failed_decrypt_count', 'last_failed_decrypt_at', 'revoked', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'session_blob' ]
 * - whitelist LIKE:   [ 'token_hash_key_version', 'ip_hash_key_version', 'user_agent' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'token_hash', 'token_hash_key_version', 'token_fingerprint', 'token_issued_at', 'user_id', 'created_at', 'version', 'last_seen_at', 'expires_at', 'failed_decrypt_count', 'last_failed_decrypt_at', 'revoked', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'session_blob' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'token_hash_key_version', 'ip_hash_key_version', 'user_agent' ];
            $likeParts = []; $i=0;
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'token_hash', 'token_hash_key_version', 'token_fingerprint', 'token_issued_at', 'user_id', 'created_at', 'version', 'last_seen_at', 'expires_at', 'failed_decrypt_count', 'last_failed_decrypt_at', 'revoked', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'session_blob' ], true);
            $parts = [];
