...
namespace BlackCat\Database\Packages\Sessions\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO SessionDto:
...
final class SessionDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'user_id', 'version', 'failed_decrypt_count' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'token_issued_at', 'created_at', 'last_seen_at', 'expires_at', 'last_failed_decrypt_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'token_hash', 'token_fingerprint', 'ip_hash', 'session_blob' ];
     ...
     * @return SessionDto
     */
    public static function fromRow(array $row): SessionDto
    {
        /** @var SessionDto */
    ...
    public static function fromRowOrNull(?array $row): ?SessionDto
    {
     ...
     */
    public static function toRow(SessionDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SessionDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SessionDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SessionDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SessionDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SessionDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SessionDto>
     */
