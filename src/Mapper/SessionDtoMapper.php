...
final class SessionDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'user_id', 'failed_decrypt_count' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'token_hash_key_version', 'token_fingerprint', 'token_issued_at', 'user_id', 'expires_at', 'last_failed_decrypt_at', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'session_blob' ];
