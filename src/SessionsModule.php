...
final class SessionsModule implements ModuleInterface {
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $indexes = [ 'idx_sessions_created_at', 'idx_sessions_expires_at', 'idx_sessions_last_seen', 'idx_sessions_token_hash_key', 'idx_sessions_user', 'idx_sessions_user_created' ];
        $fks     = [ 'fk_sessions_user' ];
        $missingIdx = [];
        $missingFk  = [];
